xmlport 87402 "wan SEPA CT pain.001.001.03"
// Copy from xmlport 1000 "SEPA CT pain.001.001.03"
{
            ...
            tableelement(companyinformation; "Company Information")
            {
                ...
                tableelement(paymentexportdatagroup; "Payment Export Data")
                {
                    ...
                    textelement(PmtTpInf)
                    {
                        ...
                        //[ 
                        //TODO à ajouter à PaymentExportDataGroup (SvcLvt/CtgyPurp et Cd) et à alimenter selon Intercompany
                        /*
                        textelement(SvcLvl)
                        {
                            textelement(Cd)
