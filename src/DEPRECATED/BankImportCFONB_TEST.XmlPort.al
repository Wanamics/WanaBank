#if FALSE
xmlport 87400 "wan Bank Rec. Import CFONB" // TEST*********************************
{
    ...
    begin
        ...
        if (BankAccReconciliation."Statement Ending Balance" <> ToAmount(_Amount, _NoOfDecimals))
            // or
            //     (BankAccReconciliation."Statement Date" <> ToDate(_OperationDate)) 
            then
