//Copy from FR localization report 10843 "Recapitulation Form"

// ------------------------------------------------------------------------------------------------
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License. See License.txt in the project root for license information.
// ------------------------------------------------------------------------------------------------
namespace Wanamics.WanaBank.CashReceipt;
...
report 87403 "wan Recapitulation Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayouts/RecapitulationForm.rdl';
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            // {
            // }
            column(CustBankAcc_IBAN_Caption; CustBankAcc.FieldCaption("IBAN")) { }
            column(CustBankAcc_NameCaption; CustBankAcc.FieldCaption(Name)) { }
            ...
            // }
            //[
            column(Bank_Account_IBAN; "No.")
            {
            }
            column(Bank_Account_IBAN_Caption; FieldCaption(IBAN))
            {
            }
            //]
            dataitem("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                dataitem(Customer; Customer)
                {
                    ...
                    // }
                    //[
                    column(CustBankAcc_IBAN; CustBankAcc.IBAN)
                    {
                    }
                    //]
