codeunit 81600 "wanaBank Import CFONB120"
{
    ...
    local procedure ImportBankAccountReconciliation(var Rec: Record 273)
    var
        TempBankAccReconciliation: Record 273 temporary;
    begin
    ...
    local procedure Fill(var pTempRec: Record 273)
    var
        lRec: Record 273;
    begin
    ...
    local procedure UpdateBankDescription(var pBankAccReconciliation: Record 273)
    var
    ...
    local procedure FecthMapping(BankAccReconciliationLine: Record 274): Boolean
    var
    ...
    var
        TextToAccountMapping: Record 1251;
    begin
        IF TextToAccountMapping.FINDSET THEN
            REPEAT
                IF COPYSTR(pValue, 1, STRLEN(TextToAccountMapping."Mapping Text")) = TextToAccountMapping."Mapping Text" THEN
                    EXIT(TRUE);
