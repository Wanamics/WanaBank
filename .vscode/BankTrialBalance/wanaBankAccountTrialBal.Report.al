report 81601 "wanaBank Account - Trial Bal."
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankAccountTrialBalance.rdl';
    ...
    var Text000: Label 'It was not possible to find a %1 in %2.';
    ...
    var TotalBalance: Decimal)var BankAccountCopy: Record 270;
    begin
