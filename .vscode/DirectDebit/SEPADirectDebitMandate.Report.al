report 81606 "wan SEPA Direct Debit Mandate"
{
    Caption = 'SEPA Direct Debit Mandate';
    DefaultLayout = Word;
    WordLayout = './wanSEPADirectDebitMandate.docx';
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            column(Comp_Address; AddressMemo(CompAddress))
            {
            }
        ...
        dataitem(SEPADirectDebitMandate; "SEPA Direct Debit Mandate")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                column(Cust_Address; AddressMemo(CustAddress))
                {
                }
                ...
                dataitem("Customer Bank Account"; "Customer Bank Account")
                {
                    ...
                    column(Bank_Address; AddressMemo(BankAddress))
                    {
                    }
    ...
    procedure AddressMemo(pAddress: array[8] of Text[100]) ReturnValue: Text;
    var
        i: Integer;
        LastOne: Integer;
    begin
